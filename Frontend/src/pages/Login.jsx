          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <input
                ...
                className={`block w-full rounded-md border px-4 py-2 text-gray-900 placeholder-gray-400 focus:border-green-500 focus:ring-green-500 sm:text-sm ${
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                  placeholder="••••••••"
                  className={`block w-full rounded-md border px-4 py-2 pr-10 text-gray-900 placeholder-gray-400 focus:border-green-500 focus:ring-green-500 sm:text-sm ${
