...
const HomePage = () => {
  return (
    <div className="w-full flex flex-col items-center gap-2 p-9">
      <HomePageNavBar />
      ...
      {/* welcome message */}
      <div className=" w-md mt-5 md:w-full md:flex md:items-center md:justify-between ">
        <HomePageUser />
        <div className=" mt-5 flex justify-center items-center  md:flex flex-row md:items-center md:mt-0 md:justify-center">
          {/*  */}
          <PrimaryButton
